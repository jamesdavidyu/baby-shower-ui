...
export const loginFormSchema = z.object({
  name: z.string().min(3, { message: "Please input a valid name." }),
...
export const guestsFormSchema = z.object({
  guests: z
    .string()
    .min(3, { message: "Please input valid names for your guests." }),
});

export type GuestsFormSchemaValidationSchemaType = z.infer<
  typeof guestsFormSchema
>;
...
export type NewGuestsFormSchemaValidationSchemaType = z.infer<
  typeof newGuestsFormSchema
>;
